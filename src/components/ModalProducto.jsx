    ...
    return (
        <div className="md:flex gap-10">
            ...
            <div className="md:w-2/3">
                ...
                <p className="text-amber-500 font-black text-5xl mt-5">{formatearDinero(producto.precio)}</p>
                ...
                <button className="bg-indigo-600 hover:bg-indigo-800 px-5 py-2 text-white font-bold uppercase rounded mt-5" type="button" onClick={() => 
                    {
